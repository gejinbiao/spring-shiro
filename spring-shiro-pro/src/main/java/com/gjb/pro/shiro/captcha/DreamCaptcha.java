package com.gjb.pro.shiro.captcha;
...
public class DreamCaptcha implements InitializingBean {
    ...
    private static final String DEFAULT_COOKIE_NAME = "captchaCookieNames";
    private final static String DEFAULT_CHACHE_NAME = "captcha";
